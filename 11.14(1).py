...
>>> 
>>> values = {}
>>> values['username'] = "3578433688@qq.com"
>>> values['password'] = "662179liu"
...
var bds={
    ...
    comm : {
        ...
        query : "",
        qid : "cdd0190200006e44",
        cid : "0",
        sid : "1420_22533_21120_24880_20927",
        indexSid : "1420_22533_21120_24880_20927",
        stoken : "",
        serverTime : "1510641103",
        user : "",
        username : "",
        userid : "0",
        loginAction : [],
        ...
        globalLogFlag:0
	,encTn:'0067ChEjPY3FZrdvB3f2NvF6HvbzFdY+R5NfQzV8PdV00icKxI+cH5YiV0A'    }
};
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-311288-edA1yF7LJK3LSjQAaGxEobLXDixkdC" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2" src="/js/libs/require.js;jsessionid=053036E53D80750AE96D753E5958DE06.tomcat2"></script>
    <script type="text/javascript">
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1" />
    <script src="https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script>
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1?username=1016903103%40qq.com&amp;password=xxxx" method="post">
                    ...
                    <!-- 该参数可以理解成每个需要登录的用户都有一个流水号。只有有了webflow发放的有效的流水号，用户才可以说明是已经进入了webflow流程。否则，没有流水号的情况下，webflow会认为用户还没有进入webflow流程，从而会重新进入一次webflow流程，从而会重新出现登录界面。 -->
					<input type="hidden" name="lt" value="LT-312265-exdbgPFbFZAwcRDpGkZanocp53nRZK" />
			 		<input type="hidden" name="execution" value="e1s1" /> 
					<input type="hidden" name="_eventId" value="submit" /> 
					<input class="logging" accesskey="l" value="登 录" tabindex="6" type="button" /> 
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<a id="wechatAuthorizationUrl" href="javascript:void(0)" onClick="show();" class="wechat" target="_parent"></a>
                   	<script src="/js/apps/weixinqr.js;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1"></script>
    ...
    <div class="footer"></div>
    <script data-main="/js/login-config.js;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1" src="/js/libs/require.js;jsessionid=DD239B1E5811DE5C9147AD3ABBC5CDA0.tomcat1"></script>
    <script type="text/javascript">
		document.write('<script type="text/javascript" src="//csdnimg.cn/pubfooter/js/publib_footer.js?' + Math.floor(new Date()/120000).toString(36) + '="></'+'script>');
	</script>
  </body>
